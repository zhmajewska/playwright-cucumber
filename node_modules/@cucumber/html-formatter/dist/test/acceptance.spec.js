...
test_1.test.beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const fixture of fixtures) {
        ...
        yield (0, promises_1.pipeline)(node_fs_1.default.createReadStream(fixture, { encoding: 'utf-8' }), new message_streams_1.NdjsonToMessageStream(), new src_1.CucumberHtmlStream(node_path_1.default.join(__dirname, '../dist/main.css'), node_path_1.default.join(__dirname, '../dist/main.js')), node_fs_1.default.createWriteStream(outputFile));
    }
}));
for (const fixture of fixtures) {
    const name = node_path_1.default.basename(fixture, '.ndjson');
